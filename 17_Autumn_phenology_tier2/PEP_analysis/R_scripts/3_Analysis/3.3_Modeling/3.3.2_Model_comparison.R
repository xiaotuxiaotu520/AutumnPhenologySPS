...
#############################################################################################################
# Driver comparison for the PEP725 data set (not used) ######################################################
#############################################################################################################
...
#variable vector
variables=c("Azani","Tday","SWrad","Moist","leaf_out","GDDday","GDDnight")
...
for (i in 1:length(variables)){
  ...
  if (variables[i] == "leaf_out") {
    covariates = c('leaf_out','CO2')
  ...
  equation.full = as.formula(paste("leaf_off ~ ", paste0(covariates[1], '+', covariates[2])))
